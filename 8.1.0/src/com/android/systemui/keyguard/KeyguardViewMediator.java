...
public class KeyguardViewMediator extends SystemUI {
    ...
    public void startKeyguardExitAnimation(long startTime, long fadeoutDuration) {
        RuntimeException startKeyguardExitAnimation = new RuntimeException("startKeyguardExitAnimation");
        startKeyguardExitAnimation.fillInStackTrace();
        Log.w("eric", "Called: " , startKeyguardExitAnimation);
