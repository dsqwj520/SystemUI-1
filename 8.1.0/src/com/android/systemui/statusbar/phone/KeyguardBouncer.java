...
public class KeyguardBouncer {
    ...
    public void show(boolean resetSecuritySelection) {
        RuntimeException keyguardBbouncerShow = new RuntimeException("keyguardBbouncerShow");
        keyguardBbouncerShow.fillInStackTrace();
        Log.w("eric", "Called: " , keyguardBbouncerShow);
