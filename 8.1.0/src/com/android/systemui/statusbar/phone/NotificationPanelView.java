...
public class NotificationPanelView extends PanelView implements
    ...
    public NotificationPanelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        log("NotificationPanelView,init");
    ...
    public void setKeyguardIndicationController(KeyguardIndicationController indicationController) {
        log("setKeyguardIndicationController");
    ...
    private void setIsFullWidth(boolean isFullWidth) {
        log("setIsFullWidth,isFullWidth="+isFullWidth);
        mIsFullWidth = isFullWidth;
        mNotificationStackScroller.setIsFullWidth(isFullWidth);
    }

    private void startQsSizeChangeAnimation(int oldHeight, final int newHeight) {
        log("startQsSizeChangeAnimation,oldHeight="+oldHeight+",newHeight="+newHeight);
    ...
    private void positionClockAndNotifications() {
        log("positionClockAndNotifications");
    ...
    public int computeMaxKeyguardNotifications(int maximum) {
        log("computeMaxKeyguardNotifications,maximum="+maximum);
    ...
    private void startClockAnimation(int x, int y) {
        log("startClockAnimation,x="+x+",y="+y);
    ...
    private void updateClock(float alpha, float scale) {
        log("updateClock,alpha="+alpha+",scale="+scale);
    ...
    public void animateToFullShade(long delay) {
        log("animateToFullShade,delay="+delay);
    ...
    public void setQsExpansionEnabled(boolean qsExpansionEnabled) {
        log("setQsExpansionEnabled,qsExpansionEnabled="+qsExpansionEnabled);
    ...
    public void fling(float vel, boolean expand) {
        log("fling, vel="+vel+",expand="+expand);
    ...
    protected void flingToHeight(float vel, boolean expand, float target,
            float collapseSpeedUpFactor, boolean expandBecauseOfFalsing) {
                log("flingToHeight, vel="+vel+",expand="+expand+",target="+target+",collapseSpeedUpFactor="+collapseSpeedUpFactor+",expandBecauseOfFalsing="+expandBecauseOfFalsing);
    ...
    public boolean dispatchPopulateAccessibilityEventInternal(AccessibilityEvent event) {
        log("dispatchPopulateAccessibilityEventInternal");
    ...
    private boolean onQsIntercept(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_UP:
                log("onQsIntercept,ACTION_POINTER_UP");
    ...
    private void flingQsWithCurrentVelocity(float y, boolean isCancelMotionEvent) {
        log("flingQsWithCurrentVelocity");
    ...
    private void onQsTouch(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_UP:
                log("onQsTouch,ACTION_POINTER_UP");
                final int upPointer = event.getPointerId(event.getActionIndex());
                if (mTrackingPointer == upPointer) {
                    // gesture is ongoing, find a new pointer to track
                    final int newIndex = event.getPointerId(0) != upPointer ? 0 : 1;
    ...
    public void onOverscrollTopChanged(float amount, boolean isRubberbanded) {
        log("onOverscrollTopChanged,amount="+amount+",isRubberbanded="+isRubberbanded);
        cancelQsAnimation();
        if (!mQsExpansionEnabled) {
            amount = 0f;
        }
    ...
    public void flingTopOverscroll(float velocity, boolean open) {
        log("flingTopOverscroll,velocity="+velocity+",open="+open);
        mLastOverscroll = 0f;
    ...
    private void setOverScrolling(boolean overscrolling) {
        log("setOverScrolling,overscrolling="+overscrolling);
    ...
    private void onQsExpansionStarted() {
        log("onQsExpansionStarted");
        onQsExpansionStarted(0);
    }

    protected void onQsExpansionStarted(int overscrollAmount) {
        log("onQsExpansionStarted,overscrollAmount="+overscrollAmount);
        cancelQsAnimation();
    ...
    private void animateKeyguardStatusBarOut() {
        log("animateKeyguardStatusBarOut");
    ...
    private void animateKeyguardStatusBarIn(long duration) {
        log("animateKeyguardStatusBarIn,duration="+duration);
    ...
    private void setKeyguardBottomAreaVisibility(int statusBarState,
            boolean goingToFullShade) {
                log("setKeyguardBottomAreaVisibility,statusBarState="+statusBarState+",goingToFullShade="+goingToFullShade);
    ...
    private void setKeyguardStatusViewVisibility(int statusBarState, boolean keyguardFadingAway,
            boolean goingToFullShade) {
                log("setKeyguardStatusViewVisibility,statusBarState="+statusBarState+",keyguardFadingAway="+keyguardFadingAway+",goingToFullShade="+goingToFullShade);
    ...
    private void setQsExpansion(float height) {
        log("setQsExpansion,height="+height);
    ...
    protected void requestScrollerTopPaddingUpdate(boolean animate) {
        log("requestScrollerTopPaddingUpdate,animate="+animate);
    ...
    public void flingSettings(float vel, boolean expand) {
        log("flingSettings, vel="+vel+",expand="+expand);
    ...
    protected void flingSettings(float vel, boolean expand, final Runnable onFinishRunnable,
            boolean isClick) {
                log("flingSettings, vel="+vel+",expand="+expand+",isClick="+isClick);
    ...
    private boolean shouldQuickSettingsIntercept(float x, float y, float yDiff) {
        log("shouldQuickSettingsIntercept, x="+x+",y="+y+",yDiff="+yDiff);
    ...
    protected boolean isScrolledToBottom() {
        log("isScrolledToBottom,isInSettings()="+isInSettings());
        if (!isInSettings()) {
    ...
    public boolean isInSettings() {
        log("isInSettings,mQsExpanded="+mQsExpanded);
        return mQsExpanded;
    }

    public boolean isExpanding() {
        log("isExpanding,mIsExpanding="+mIsExpanding);
        return mIsExpanding;
    }

    @Override
    protected void onHeightUpdated(float expandedHeight) {
        log("onHeightUpdated,expandedHeight="+expandedHeight);
    ...
    private int getTempQsMaxExpansion() {
        log("getTempQsMaxExpansion,mQsMaxExpansionHeight="+mQsMaxExpansionHeight);
        return mQsMaxExpansionHeight;
    }

    private int calculatePanelHeightShade() {
        log("calculatePanelHeightShade");
    ...
    private int calculatePanelHeightQsExpanded() {
        log("calculatePanelHeightQsExpanded");
    ...
    private void updateNotificationTranslucency() {
        log("updateNotificationTranslucency");
        float alpha = 1f;
    ...
    protected float getOverExpansionAmount() {
        log("getOverExpansionAmount");
        return mNotificationStackScroller.getCurrentOverScrollAmount(true /* top */);
    }

    @Override
    protected float getOverExpansionPixels() {
        log("getOverExpansionPixels");
        return mNotificationStackScroller.getCurrentOverScrolledPixels(true /* top */);
    }

    private void updateUnlockIcon() {
        log("updateUnlockIcon");
        if (mStatusBar.getBarState() == StatusBarState.KEYGUARD
    ...
    private void updateKeyguardBottomAreaAlpha() {
        log("updateKeyguardBottomAreaAlpha");
    ...
    private void setListening(boolean listening) {
        log("setListening,listening="+listening);
    ...
    public void expand(boolean animate) {
        ...
        log("expand,animate="+animate);
        setListening(true);
    }

    @Override
    protected void setOverExpansion(float overExpansion, boolean isPixels) {
        log("setOverExpansion,overExpansion="+overExpansion+",isPixels="+isPixels);
    ...
    protected void onTrackingStopped(boolean expand) {
        log("onTrackingStopped, expand="+expand);
    ...
    public void onHeightChanged(ExpandableView view, boolean needsAnimation) {
        log("onHeightChanged, needsAnimation="+needsAnimation);
    ...
    public void onAnimationToSideStarted(boolean rightPage, float translation, float vel) {
        log("onAnimationToSideStarted,rightPage="+rightPage+",translation="+translation+",vel="+vel);
    ...
    private void startHighlightIconAnimation(final KeyguardAffordanceView icon) {
        log("startHighlightIconAnimation");
    ...
    public void onIconClicked(boolean rightIcon) {
        log("onIconClicked,rightIcon="+rightIcon);
        if (mHintAnimationRunning) {
            return;
        }
    ...
    public float getAffordanceFalsingFactor() {
        log("getAffordanceFalsingFactor");
        return mStatusBar.isWakeUpComingFromTouch() ? 1.5f : 1.0f;
    }

    @Override
    public boolean needsAntiFalsing() {
        log("needsAntiFalsing");
    ...
    protected boolean shouldUseDismissingAnimation() {
        log("shouldUseDismissingAnimation");
    ...
    protected boolean fullyExpandedClearAllVisible() {
        log("fullyExpandedClearAllVisible");
    ...
    public boolean isLaunchTransitionFinished() {
        log("isLaunchTransitionFinished");
        return mIsLaunchTransitionFinished;
    }

    public boolean isLaunchTransitionRunning() {
        log("isLaunchTransitionRunning");
    ...
    public void setEmptyDragAmount(float amount) {
        log("setEmptyDragAmount,amount="+amount);
        float factor = 0.8f;
        if (mNotificationStackScroller.getNotGoneChildCount() > 0) {
            factor = 0.4f;
    ...
    public void setDozing(boolean dozing, boolean animate) {
        log("setDozing,dozing="+dozing+",animate="+animate);
    ...
    private void updateDozingVisibilities(boolean animate) {
        log("updateDozingVisibilities,animate="+animate);
        if (mDozing) {
            mKeyguardStatusBar.setVisibility(View.INVISIBLE);
    ...
    public void showEmptyShadeView(boolean emptyShadeViewVisible) {
        log("showEmptyShadeView,emptyShadeViewVisible="+emptyShadeViewVisible);
        mShowEmptyShadeView = emptyShadeViewVisible;
        updateEmptyShadeView();
    }

    private void updateEmptyShadeView() {
        log("updateEmptyShadeView");
    ...
    public void setQsScrimEnabled(boolean qsScrimEnabled) {
        log("setQsScrimEnabled,qsScrimEnabled="+qsScrimEnabled);
    ...
    public void onEmptySpaceClicked(float x, float y) {
        log("onEmptySpaceClicked,x="+x+",y="+y);
        onEmptySpaceClick(x);
    }
    ...
    public void onHeadsUpPinnedModeChanged(final boolean inPinnedMode) {
        log("onHeadsUpPinnedModeChanged,inPinnedMode="+inPinnedMode);
    ...
    public void setHeadsUpAnimatingAway(boolean headsUpAnimatingAway) {
        log("setHeadsUpAnimatingAway,headsUpAnimatingAway="+headsUpAnimatingAway);
    ...
    protected void onClosingFinished() {
        ...
        log("onClosingFinished");
        resetVerticalPanelPosition();
        setClosingWithAlphaFadeout(false);
    }

    private void setClosingWithAlphaFadeout(boolean closing) {
        log("setClosingWithAlphaFadeout,closing="+closing);
    ...
    protected void updateVerticalPanelPosition(float x) {
        log("updateVerticalPanelPosition,x="+x);
    ...
    private void resetVerticalPanelPosition() {
        log("resetVerticalPanelPosition");
        setVerticalPanelTranslation(0f);
    }

    protected void setVerticalPanelTranslation(float translation) {
        log("setVerticalPanelTranslation,translation="+translation);
        mNotificationStackScroller.setTranslationX(translation);
        mQsFrame.setTranslationX(translation);
    }

    protected void updateExpandedHeight(float expandedHeight) {
        log("updateExpandedHeight,expandedHeight="+expandedHeight);
        if (mTracking) {
    ...
    public void setPanelScrimMinFraction(float minFraction) {
        log("setPanelScrimMinFraction,minFraction="+minFraction);
        mBar.panelScrimMinFractionChanged(minFraction);
    }

    public void clearNotificationEffects() {
        log("clearNotificationEffects");
        mStatusBar.clearNotificationEffects();
    }

    @Override
    protected boolean isPanelVisibleBecauseOfHeadsUp() {
        log("isPanelVisibleBecauseOfHeadsUp");
        return mHeadsUpManager.hasPinnedHeadsUp() || mHeadsUpAnimatingAway;
    }

    @Override
    public boolean hasOverlappingRendering() {
        log("hasOverlappingRendering");
        return !mDozing;
    }

    public void launchCamera(boolean animate, int source) {
        log("launchCamera,animate="+animate+",source="+source);
    ...
    public void setVisibility(int visibility) {
        ...
        log("setVisibility，visibility="+visibility);
        updateFullyVisibleState(false /* forceNotFullyVisible */);
    }

    private void updateFullyVisibleState(boolean forceNotFullyVisible) {
        log("updateFullyVisibleState，forceNotFullyVisible="+forceNotFullyVisible);
    ...
    private void setLaunchingAffordance(boolean launchingAffordance) {
        log("setLaunchingAffordance，launchingAffordance="+launchingAffordance);
    ...
    public boolean canCameraGestureBeLaunched(boolean keyguardIsShowing) {
        log("canCameraGestureBeLaunched，keyguardIsShowing="+keyguardIsShowing);
    ...
    private boolean isForegroundApp(String pkgName) {
        log("isForegroundApp，pkgName="+pkgName);
    ...
    public boolean hideStatusBarIconsWhenExpanded() {
        log("hideStatusBarIconsWhenExpanded");
    ...
    public void setDark(boolean dark, boolean animate) {
        log("setDark,dark="+dark+",animate="+animate);
    ...
    private void setDarkAmount(float amount) {
        log("setDarkAmount,amount="+amount);
        mDarkAmount = amount;
    ...
    public void setNoVisibleNotifications(boolean noNotifications) {
        log("setNoVisibleNotifications,noNotifications="+noNotifications);
    ...
    public void setPulsing(boolean pulsing) {
        log("setPulsing,pulsing="+pulsing);
        mKeyguardStatusView.setPulsing(pulsing);
    }

    public void setAmbientIndicationBottomPadding(int ambientIndicationBottomPadding) {
        log("setAmbientIndicationBottomPadding,ambientIndicationBottomPadding="+ambientIndicationBottomPadding);
    ...
    public void setStatusAccessibilityImportance(int mode) {
        log("setStatusAccessibilityImportance,mode="+mode);
    ...
    public KeyguardBottomAreaView getKeyguardBottomAreaView() {
        log("getKeyguardBottomAreaView");
        return mKeyguardBottomArea;
    }

    public void setUserSetupComplete(boolean userSetupComplete) {
        log("setUserSetupComplete,userSetupComplete="+userSetupComplete);
